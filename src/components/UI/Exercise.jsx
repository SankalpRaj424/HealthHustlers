      ...
      <div className='container exercise_container'>
        <div className='exercise_top'>
          <h2 className='section_title'>
            Advantages of Regular <span className='highlights'>Physical Activity</span>
          </h2>

          <p>
          Regular physical activity offers a multitude of benefits <br /> for both physical and 
          mental health.
          </p>
        </div>
